...
function ingresarFormularioCliente(){
  ...
  $("#FormularioCliente").css({"animation":"AparecerCliente 0.5s ease-out 0s normal"});
  $("#FormularioEmpresa").css({"animation":"DesaparecerEmpresa 0.5s ease-out 0s normal"});
}
...
function ingresarFormularioEmpresa(){
  ...
  $("#FormularioCliente").css("display", "none");
  $("#FormularioCliente").css({"animation":"DesaparecerCliente 0.5s ease-out 0s normal"});
  $("#FormularioEmpresa").css({"animation":"AparecerEmpresa 0.5s ease-out 0s normal"});
}
